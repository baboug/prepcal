          ...
          <>
            ...
            {isLoading && (
              <span className="absolute transition-all">
                <LoaderCircle aria-hidden="true" className="animate-spin" size={14} strokeWidth={2} />
              </span>
            )}
          </>
        )}
...
const StepperTitle = React.forwardRef<HTMLHeadingElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => <h3 className={cn("font-semibold text-sm", className)} ref={ref} {...props} />
);
