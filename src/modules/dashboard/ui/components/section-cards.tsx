...
export function SectionCards() {
  return (
    <div className="grid @5xl/main:grid-cols-4 @xl/main:grid-cols-2 grid-cols-1 gap-4 px-4 *:data-[slot=card]:bg-gradient-to-t *:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-muted-foreground/5 *:data-[slot=card]:shadow-xs lg:px-6 dark:*:data-[slot=card]:bg-card">
