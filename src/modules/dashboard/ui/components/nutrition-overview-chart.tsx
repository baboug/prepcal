  ...
  const chartData = [
    {
      ...
      percentage: Math.min((todayNutrition.calories / targets.calories) * 100, 100),
      fill: "var(--calories)",
    },
    {
      nutrient: "protein",
      ...
      percentage: Math.min((todayNutrition.protein / targets.protein) * 100, 100),
      fill: "var(--protein)",
    },
    {
      nutrient: "carbs",
      ...
      percentage: Math.min((todayNutrition.carbs / targets.carbs) * 100, 100),
      fill: "var(--carbs)",
    },
    {
      nutrient: "fat",
      ...
      target: targets.fat,
      percentage: Math.min((todayNutrition.fat / targets.fat) * 100, 100),
      fill: "var(--fat)",
    },
  ];
